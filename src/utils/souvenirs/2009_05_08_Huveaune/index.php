...
<br />
 ...
 <img id="defilement1" src="1.jpg" width = 800px style="-moz-opacity:0;filter:alpha(opacity=0);margin-top:10px; margin-left:200px; ">
  photo A n° <? $Photo++; echo $Photo;?>
<!-- Deuxieme image id=defilement2    /!\ positionnée RELATIVEMENT par rapport à la 1ère /!\ -->
<img src="2.jpg"  id="defilement2" width = 800px style="-moz-opacity:1;filter:alpha(opacity=100); position:relative;top:-600px;left:200px;">
 photo B n° <? $Photo++; echo " $Photo"; ?>
