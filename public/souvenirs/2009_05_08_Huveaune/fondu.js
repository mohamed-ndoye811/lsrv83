...
// toutes les photos doivent �tre nomm�es 1.jpg ; 2.jpg . 3.jpg....
var coef = 0.05; // avancement de l'opacit�
var temps = 50; // temps entre chaque changement d'opacit�
var temps_pause = 3000; // temps d'attente entre 2 changements d'images
var nombre_image = 14; // nombre d'images � faire bouger
var suffix_image = ".jpg"; // suffix + '.extension' du nom des images

// pas touche
var indice = 2; // les 2 premiere image sont deja charg�es dans le HTML, on commence � la 3eme
...
function prechargerImg() {
  ...
  for (i = 0; i <= nombre_image - 1; i++) {
    tabImg[i] = new Image();
    tabImg[i].src = i + 1 + suffix_image; // le nom du chemin � disparu car 'fondu.js' se trouve dans le m�me dossier
  }
}
...
function change_opacity() {
  ...
  // on fait varier le sens d'opacit� du bazar
  if (opacity2 <= 0) {
